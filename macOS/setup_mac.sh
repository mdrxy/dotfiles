...
# Remove accounts from Insync

BREWFILE_PATH="ENTER BREWFILE PATH HERE"
SYS_USERNAME="ENTER SYSTEM USERNAME HERE"
DEVICE_OWNER="ENTER DEVICE OWNER FULL NAME HERE"
DEVICE_OWNER_EMAIL="ENTER DEVICE OWNER EMAIL HERE"

# Directory where iTerm2 will look for preferences
ITERM_PREFS_LOCATION="ENTER ITERM2 PREFERENCES LOCATION HERE"
...
ZSH="$ZDOTDIR/omz" sh install.sh --unattended
...
echo "Set cursor size to be larger"
defaults write com.apple.universalaccess mouseDriverCursorSize -float 1.48
...
echo "Reduce spacing between menu bar icons"
...
macOS
- Assumes we're logged into iCloud, and iCloud Drive is enabled and sync'd
- System Settings
  - Disable Spotlight shortcut -> System Settings -> Keyboard -> Keyboard Shortcuts... -> Spotlight -> Uncheck "Show Spotlight search" and "Show Finder search window"
  - Notifications
    - Turn off
...
Safari
- Hide "What's new in Safari" banner
...
- Settings
  - General
    ...
    - Delete shortcut: "Show Quick Access"
    - Delete shortcut: "Lock 1Password"
  - Appearance
    - Density: "Compact"
  - Security
    - Unlock
      - Require password: "Every 30 days"
    - Auto-lock
      - Uncheck: "Lock on sleep, screensaver, or switching users"
    - Clipboard
      - Check: "Use Universal Clipboard to copy to other devices"
  - Privacy
    - Watchtower
      - Check: "Check for vulnerable passwords"
      - Uncheck: "Check for two-factor authentication"
      - Uncheck: "Check for passkeys"
  - Browser
    - Connet to additional browsers
      - Connect to Firefox
      - Connect to Chrome
  - Developer
    - SSH Agent
      - Set up SSH Agent (Use Key Names, open SSH URLs with iTerm2)
    - Command-Line Interface (CLI)
      - Check: "Integrate with 1Password CLI"
    - Watchtower
      - Check: "Check for developer credentials on disk"
  - Advanced
    - Release channel: "Beta"
- Configure Git commit signing with SSH
  - FIRST: perform Git config via GitHub Desktop app
  - Open personal signing key
  - Click the three dots > "Configure Commit Signing"
  - Click "Edit automatically"

Alfred
- Activate Powerpack
- Enable shortcut 'command' + 'space'
- Set up sync
- "Keep clipboard history" might need to be enabled for some reason ("Keep Plain Text")

Backblaze
- Complete manual installation

Downie
- Downloads Destination: "iCloud Downloads"
- Activate license

VSCode
- Log in and set up sync through personal Github account
- Log in through GitHub for Pull Requests extension

VLC
- Enable metadata retrieval
- Change theme to "Dark"
- Uncheck: "Display VLC status menu icon"
...
- Settings
  ...
  - Appearance
    - Theme: "Dark"
  - Advanced
    - Uncheck "Help GitHub Desktop improve by sending usage stats"

Hazel
- Add license (ignore prompts - go to menu bar > Hazel > "License..." and import a copy downloaded from 1Password)
...
- Settings
  ...
  - Utilities
    - Set IINA as the Defaults Application
      - Video

Insync
- Uncheck "Anonymously send usage data to Insync to help us improve your experience"
- Add accounts

Fonts
- Select all files in "Fonts/" and "command" + "o" to install
- This could be automated at some point usint Homebrew

Firefox
- Turn off bookmarks bar via "command" + "shift" + "b"
- Remove from toolbar:
  - Firefox View (left of the first open tab)
  - Refresh
  - Pocket
  - Account
- Extensions (for each - allow in private windows)
  - 1Password - Password Manager
    - Appearance & shortcuts
      - Appearance: "Dark"
      - Open 1Password to: "All Items"
      - Check: "Show app and website icons"
  - Dark Reader
  - Tabliss
    - Settings
      - Persist Settings -> "Ask firefox to persist settings"
  - uBlock Origin
    - Un-pin from toolbar after installing
    - Settings
      - Theme: "Dark"
      - Check: "I am an advanced user"
    - Filter lists
      - Privacy
        - Check: "AdGuard URL Tracking Protection"
        - Apply changes
    - Trusted sites
      - Add:
        - bowdoin.campusgroups.com
        - docs.google.com
        - login.bowdoin.edu
        - www.chase.com
      - Apply changes
        - NEVER REMOVE (https://github.com/gorhill/uBlock/wiki/Dashboard:-Trusted-sites):
  ...
  - Web Scrobbler
    ...
    - Options
      - General
        - Uncheck: "Scrobble podcasts"
        - Uncheck: "Love/unlove tracks through players"
      - YouTube
        - Check: "Scrobble only videos that are recognized by YouTube Music as music"
        - Check: "Use YouTube Music to get track info"
      - Connectors
        - Uncheck: "YouTube"
        - Uncheck: "Bandcamp"
        - Uncheck: "Spotify"
        - Uncheck: "Internet Archive"
        - Uncheck: "Music Player for Google Drive"
  - Wikiwand: Wikipedia Modernized
  - YouTube search engine
- about:preferences#general
  - Tabs
    - Uncheck: "Confirm before quitting with command + q"
  - Files and Applications
    - Downloads
      - Save files to: "iCloud Downloads"
...
- about:preferences#search
  ...
  - Search Suggestions
    - Uncheck all except "Show recent searches"
...
- about:preferences#privacy
  - Select "Custom"
    - Change "Cookies" to block "All cross-site cookies"
    - Make "Tracking content" and "Suspected fingerprinters" block "In all windows"
  - Website Privacy Preferences
    - Check:
      - "Tell websites not to sell or share my data"
  - Passwords
    - Make sure 1Password is listed to control this setting
  ...
  - Permissions
    ...
    - Virtual Reality
      - Check "Block new requests asking to access your virtual reality devices"
...
- "Settings..."
  ...
  - iMessage
    - Turn off
      - Reach at iCloud email
      - Reach at personal email
...
- "Settings..."
  - General
    - Turn on
      - "Automatic Downloads"
      - "Star ratings"
- Enabled: "Album", "Artist", "Bit Rate", "Cloud Download", "Comments", "Date Added", "Favorite", "Genre", "Last Played", "Plays", "Rating", "Release Date", "Size", "Time", "Year" in the order: "Album by Artist", "Track Number", "Title", "Cloud Download", "Time", "Artist", "Album", "Genre", "Comments", "Favorite", "Rating", "Plays", "Year", "Release Date", "Last Played", "Date Added", "Size", "Bit Rate"
- Under "View Options"
  - "Sort by: Date Added"
  - "Show artwork"
  - "Artwork size: 0"
  - Show column browser (command + B)

MySQL
- As needed install instructions: https://formulae.brew.sh/formula/mysql#default

Twilio
- As needed, need to run "twilio login" OR "twilio profiles:create"
- Run "twilio autocomplete"

Run "brew autoremove && brew cleanup" after reboot
